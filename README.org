...
** Theme
I modified the atom-dark theme a little bit. The file =atom-dark-theme= in =.emacs.d= is the modified version. Change it back to =atom-dark-theme.el= then Emacs will load it correctly.
